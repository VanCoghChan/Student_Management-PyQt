...
class TitleBar(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.titleLabel.setStyleSheet("QLabel{color:rgb(255,48,48,250);font-size:15px;font-weight:blod;font-family:微软雅黑;}")
...
class FramelessWindow(QWidget):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # # self.lab.setGeometry(100,500,300,200)
        # pixmap = QtGui.QPixmap('bg3.jpg')
        # self.lab.setPixmap(
        #     pixmap
        # )
        ...
        pixmap = QtGui.QPixmap('./piliang_ico/bg3.jpg')
